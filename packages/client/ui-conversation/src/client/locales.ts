...
export const zh = {
  ...
  'input.commands': '命令',
  'input.attach': '添加附件',
  'input.attachFiles': '上传文件',
  'input.attachFolder': '上传文件夹',
  'input.attachedFiles': '待发送文件',
  'input.removeFile': '移除文件 {name}',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'input.fileTooLarge': '文件“{name}”超过 {size}，无法直接作为文本发送',
  'input.fileHeader': '文件：{name}',
  'input.fileFooter': '文件结束：{name}',
  'input.videoFrames': '\n\n[视频“{name}”已提取 {count} 个画面（时长 {duration}，分辨率 {resolution}），请结合这些画面回答。]\n',
  'input.videoProcessing': '正在处理视频“{name}”…',
  'input.unsupportedFile': '暂不支持“{name}”。可上传图片、视频，或 1 MB 以内的文本/代码文件',
  'input.fileError': '无法读取文件“{name}”',
  'video.tooLarge': '视频“{name}”超过 500 MB，无法提取画面',
  'video.noFrames': '视频“{name}”没有可提取的画面',
  'video.noContext': '浏览器无法创建视频画面',
  'video.metadataFailed': '无法读取视频“{name}”',
  'video.metadataTimeout': '视频“{name}”加载超时',
  'video.seekFailed': '无法读取视频画面“{name}”',
  'video.seekTimeout': '视频“{name}”画面提取超时',
  ...
  'file.dropTitle': '拖动文件到此处即可添加',
  'file.dropDesc': '支持图片、视频和 1 MB 内的文本/代码文件',
  'file.dropBlocked': '当前无法添加文件',
  'file.attachments': '附件',
  'file.unnamed': '未命名文件',
  'file.bytes': '{bytes} 字节',
  'file.extracted': '已提取 {chars} 个字符',
  'file.extractionFailed': '提取失败：{message}',
  'file.preview': '查看提取预览',
...
export const en = {
  ...
  'input.attach': 'Add attachment',
  'input.attachFiles': 'Upload files',
  'input.attachFolder': 'Upload folder',
  'input.attachedFiles': 'Files ready to send',
  'input.removeFile': 'Remove file {name}',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'input.fileTooLarge': 'File "{name}" exceeds {size} and cannot be sent as text',
  'input.fileHeader': 'File: {name}',
  'input.fileFooter': 'End of file: {name}',
  'input.videoFrames': '\n\n[Video "{name}" — {count} frames extracted ({duration}, {resolution}), please refer to the frames when answering.]\n',
  'input.videoProcessing': 'Processing video "{name}"…',
  'input.unsupportedFile': '"{name}" is not supported. Upload images, videos, or text/code files under 1 MB.',
  'input.fileError': 'Could not read file "{name}"',
  'video.tooLarge': 'Video "{name}" exceeds 500 MB and cannot be processed for frames',
  'video.noFrames': 'Video "{name}" has no extractable frames',
  'video.noContext': 'Browser could not create a canvas context for video frame extraction',
  'video.metadataFailed': 'Could not read video "{name}"',
  'video.metadataTimeout': 'Video "{name}" metadata loading timed out',
  'video.seekFailed': 'Could not extract video frame from "{name}"',
  'video.seekTimeout': 'Video "{name}" frame extraction timed out',
  ...
  'file.dropTitle': 'Drag files here to add them',
  'file.dropDesc': 'Supports images, videos, and text/code files up to 1 MB',
  'file.dropBlocked': 'Files cannot be added right now',
  'file.attachments': 'Attachments',
  'file.unnamed': 'Unnamed file',
  'file.bytes': '{bytes} bytes',
  'file.extracted': '{chars} characters extracted',
  'file.extractionFailed': 'Extraction failed: {message}',
  'file.preview': 'View extracted preview',
