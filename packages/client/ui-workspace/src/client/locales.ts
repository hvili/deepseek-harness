...
export const zh = {
  ...
  'favorite.aria': '已收藏',
  'menu.editTags': '编辑标签',
  'tags.session.title': '编辑会话标签',
  'tags.workspace.title': '编辑工作区标签',
  'tags.field': '标签（用逗号分隔）',
  'tags.save': '保存标签',
  'tags.invalid': '标签过多或过长（最多 24 个，每个不超过 64 字符）',
...
export const en = {
  ...
  'menu.unfavoriteSession': 'Remove from favorites',
  'favorite.aria': 'Favorite',
  'menu.editTags': 'Edit tags',
  'tags.session.title': 'Edit session tags',
  'tags.workspace.title': 'Edit workspace tags',
  'tags.field': 'Tags (comma-separated)',
  'tags.save': 'Save tags',
  'tags.invalid': 'Too many tags or one is too long (max 24 tags, 64 characters each)',
