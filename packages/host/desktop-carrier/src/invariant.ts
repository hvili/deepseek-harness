/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-host-desktop-carrier`.
 * @module @deepseek-ai/dsh-host-desktop-carrier/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-host-desktop-carrier'
