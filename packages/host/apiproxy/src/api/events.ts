...
export type HostFrame =
  ...
  | { type: 'host/favorite-sessions-changed'; favoriteSessionIds: SessionId[] }
  | { type: 'host/workspace-tags-changed'; workspaceTagsById: Record<string, string[]>; sessionTagsById: Record<string, string[]> }
  /**
