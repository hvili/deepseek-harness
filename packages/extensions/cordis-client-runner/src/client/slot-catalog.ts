...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:295',
  },
  {
  ...
  {
    key: 'conversation.message.files',
    kind: 'single',
    scope: 'session',
    summary: 'Optional renderer for durable file references and their extraction status.',
    doc: 'Optional renderer for durable file references and their extraction status.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation.view\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-attachment MessageFiles',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:107',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins VisionProxyCard',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-general DiagnosticsSection id \'diagnostics\'',
      'client-ui-settings-models ModelsSection id \'models\'',
      'client-ui-settings-plugins PluginsSettingsSection id \'plugins\'',
      'client-ui-settings-plugins ArchivedSessionsTab id \'archived-sessions\'',
    ],
    replaceRisk: 'none',
