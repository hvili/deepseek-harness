...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WorkspaceFavoriteSessionRequest: 'workspace.md',
  WorkspaceFavoriteValue: 'workspace.md',
  ...
  WorkspaceSessionTagsValue: 'workspace.md',
  WorkspaceSetSessionTagsRequest: 'workspace.md',
  WorkspaceSetWorkspaceTagsRequest: 'workspace.md',
  WorkspaceUnfavoriteSessionRequest: 'workspace.md',
  WorkspaceValue: 'workspace.md',
  WorkspaceWorkspaceTagsValue: 'workspace.md',
