...
| [restore.md](restore.md) | the restore/upgrade seam: sandbox-confined restore preview, operator approval, transactional replay, and format-version upgrade guard |
